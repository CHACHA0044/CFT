...
export const buttonColorConfigs = {
    ...
    forgotPassword: { id: 'forgotPassword', baseColor: '#f59e0b', schemes: ['linear-gradient(145deg, #f59e0b, #d97706)', 'linear-gradient(145deg, #fbbf24, #f59e0b)', 'linear-gradient(145deg, #fb923c, #ea580c)', 'linear-gradient(145deg, #fcd34d, #f97316)', 'linear-gradient(145deg, #ff7f50, #ff4500)' ]},
    ...
    home: { id: 'home',baseColor: '#06b6d4', schemes: [ 'linear-gradient(145deg, #06b6d4, #0891b2)', 'linear-gradient(145deg, #0ea5e9, #0284c7)', 'linear-gradient(145deg, #14b8a6, #0d9488)', 'linear-gradient(145deg, #22d3ee, #06b6d4)', 'linear-gradient(145deg, #ff7f50, #ff4500)' ]},
};
...
export const SaveButton = ({ text = "Save", className, ...props }) => <GlobalButton text={text} iconType="save" colorConfig={buttonColorConfigs.save} className={className} {...props} />;
...
export const HomeButton = ({ className, ...props }) => { const navigate = useNavigate(); const handleClick = () => { setTimeout(() => { navigate('/'); }, 500); }; return ( <GlobalButton text="Home" iconType="home" colorConfig={buttonColorConfigs.home} onClick={handleClick} styleOverride={{ width: '10rem', height: '3.5rem' }} className={className} {...props} /> );};
...
export const ForgotPasswordButton = ({ className, ...props }) => (
  <GlobalButton
    text="Forgot Password?"
    iconType="email"
    colorConfig={buttonColorConfigs.forgotPassword}
    className={className}
    styleOverride={{ width: '100%' }}
    {...props}
  />
