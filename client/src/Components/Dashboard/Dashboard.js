...
const AnimatedHeadline = React.memo(() => {
  ...
  return (
    <div className="relative overflow-visible w-full flex justify-center items-center px-4">
      <motion.div
        className="flex flex-wrap -mt-3 justify-center gap-3 text-4xl sm:text-6xl md:text-8xl font-black font-germania tracking-wider text-shadow-DEFAULT text-white"
        initial={false}
        animate={false}
      >
