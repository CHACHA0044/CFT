...
const dailyMessages = {
    0: { 
      emoji: "🌞",
      message: "Sunday Reset : Reflect on your weekly progress and set new green goals",
    ...
    1: { 
      emoji: "💪",
      message: "Fresh Start Monday : Transform this week with sustainable choices today",
    ...
    2: { 
      emoji: "🌱",
      message: "Green Tuesday : Every plant you nurture helps combat climate change daily",
    ...
    3: { 
      emoji: "🌍",
      message: "Midweek Momentum : Small daily actions create massive overall results",
    ...
    4: { 
      emoji: "♻️",
      message: "Thoughtful Thursday : One bottle recycled today fuels tomorrow’s energy",
    ...
    5: { 
      emoji: "🎉",
      message: "Freedom Friday : Plan adventures that celebrate nature without harming it",
    ...
    6: { 
      emoji: "🚴",
      message: "Active Saturday : Choose bike rides and walks for zero emission adventures",
  ...
  return (
    <div className="relative rounded-3xl w-full max-w-3xl mx-auto py-6 px-4 overflow-hidden mt-4 mb-8">
