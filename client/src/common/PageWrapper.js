  ...
  <AnimatePresence>
    {showInfo && (
      <motion.div
        ...
        className="absolute bottom-full hidden sm:block -ml-48 left-1/2 transform -translate-x-1/2 -mb-3 bg-emerald-500/90 dark:bg-black/90 text-white px-4 py-2 rounded-xl shadow-lg text-sm font-medium text-center z-50 whitespace-nowrap"
      >
        Version {appVersion.version} • Update includes new weather section
      </motion.div>
    )}
  </AnimatePresence>
