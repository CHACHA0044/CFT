...
const AnimatedHeadline = React.memo(() => {
  ...
  return (
    <div className="relative overflow-visible w-full flex justify-center items-center px-4">
      <motion.div
        className="flex flex-wrap justify-center gap-3 text-4xl sm:text-6xl md:text-8xl font-black font-germania tracking-widest text-shadow-DEFAULT text-emerald-500 dark:text-white"
        initial={false}
        animate={false}
      >
          ...
          <div className="flex flex-col items-center justify-center w-full px-6 py-6">
            ...
            >
              ...
              <h3 className="sm:text-xl sm:tracking-wide text-base font-intertight text-center text-shadow-DEFAULT text-emerald-500 dark:text-gray-100">
                Let's measure your environmental footprint together <span className="animate-earth-spin"><span>🌎</span></span>
              </h3>
